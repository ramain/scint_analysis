...
if __name__ == '__main__':
    ...
    dR = np.concatenate((dchan[...,0], dchan[...,1], dchan[...,2], dchan[...,3], dchan[...,4], dchan[...,5], dchan[...,6], dchan[...,7], dchan[...,8], dchan[...,9], dchan[...,10], dchan[...,11], dchan[...,12], dchan[...,13], dchan[...,14], dchan[...,15]), axis=1)
    plt.ion()
    plt.imshow(abs(dR).T, aspect='auto')
